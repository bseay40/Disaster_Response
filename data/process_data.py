...
def load_data(messages_filepath, categories_filepath):
    '''
    Loads the message and categories datasets and merges them into single df.
    Inputs are the filepaths to the message (messages_filepath) and
    categories (categories_filepath) datasets.
    '''
